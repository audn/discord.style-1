...
import TemplateCard, { TemplateCardReport } from '~/components/TemplateCard'
        ...
        <div className="container">
          <div className="row">
            <div className="col md:w-2/3 lg:w-1/2 text-white">
              <h1 className="text-4xl font-bold mb-4 leading-tight">Reports</h1>
              <p className="text-discord-600 font-medium text-lg lg:w-5/6">
                Reports: <strong>3</strong>
              </p>
            </div>
          </div>
        </div>
